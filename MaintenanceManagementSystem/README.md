...
└── MaintenanceManagementSystem.Tests/  # xUnit test project
```
...
```bash
git clone https://github.com/Oz05-jpg/MaintenanceManagementSystem.git
```

2. Update connection string in `appsettings.json`
```json
"ConnectionStrings": {
  "DefaultConnection": "Server=(localdb)\\mssqllocaldb;Database=MaintenanceManagementDb;Trusted_Connection=True;"
}
```
